...
function bildAnzeigeZoom() {
	...
	var temp = "Wellcome49_" + zusatz + curSlide + addChar + rectoVerso;
...
function bildAnzeigeES() {
	if (((curSlide >= firstPageES) && (curSlide < lastPageES + 1))) {
		...
		switch (blatt) {
			...
			case "-1r": blattAngabe = "Einband vorne aussen"; lagenAngabe = ""; bildURL = zoom + "/Wellcome49_00Einband_vorne_aussen.jpg"; buchAuswahl = aktBuch + 1; break;
			...
			case "71r": blattAngabe = "Einband hinten innen"; lagenAngabe = ""; bildURL = zoom + "/Wellcome49_00Einband_hinten_innen.jpg"; buchAuswahl = aktBuch + 1; break;
			case "71v": blattAngabe = "Einband hinten aussen"; lagenAngabe = ""; bildURL = zoom + "/Wellcome49_00Einband_hinten_aussen.jpg"; buchAuswahl = aktBuch + 1; break;
			case "72r": blattAngabe = "Einband Ruecken"; lagenAngabe = ""; bildURL = zoom + "/Wellcome49_00Einband_Ruecken.jpg"; buchAuswahl = aktBuch + 1; break;
			default: blattAngabe = "Bl. " + blattalt; lagenAngabe = lagenNr + lagenName; buchAuswahl = aktBuch + 1; break;
			
			/*
			Wellcome49_00Einband_Schliessen.jpg
			Wellcome49_00Einband_Schnitt_oben.jpg
			Wellcome49_00Einband_Schnitt_unten.jpg
...
function bildAnzeigeDS() {
	...
	var tempv = "Wellcome49_" + zusatzv + curSlide + addChar + 'v';
	var tempr = "Wellcome49_" + zusatzr + nexSlide + nexChar + 'r';
	...
	switch (curSlide) {
		...
		case "71":  
			...
			bildURLr = "50/Wellcome49_00Einband_Ruecken.jpg"; break;
		default: break;
	...
	switch (curSlide) {
		...
		case "70": seitenAngabe = "Bl. " + curSlide + addChar + "v / Einband hinten innen"; lagenAngabe = lagenNr + lagenName; buchAuswahl = aktBuch + 1; break;
		case "71": seitenAngabe = "Einband hinten aussen / Einband Rücken"; lagenAngabe = lagenNr + lagenName; buchAuswahl = aktBuch + 1; break;
