...
function goPrevPage() {
	if (zoom == 50) {
		...
		if (!((curSlide == firstPageES) && (rectoVerso == firstPageRV))) {
			if (rectoVerso == "r") {
				if (addPage.has(parseInt(curSlide))) {
					if (addChar == "a") {
						curSlide--;
...
function bildAnzeigeZoom() {
	...
	var temp = "Basel_KII11_" + zusatz + curSlide + addChar + rectoVerso;
...
function bildAnzeigeES() {
	if (((curSlide >= firstPageES) && (curSlide < lastPageES+1))) {
		...
		switch (blatt) {
			...
			//case "-1r": blattAngabe = "Einband vorne aussen"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_00Einband_vorne_aussen.jpg"; buchAuswahl = aktBuch + 1; break;
			...
			case "-3r": blattAngabe = "Einband vorne aussen"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_Einband_vorne_aussen.jpg"; buchAuswahl = aktBuch + 1; break;
			case "-3v": blattAngabe = "Einband vorne innen"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_Einband_vorne_innen.jpg"; buchAuswahl = aktBuch + 1; break;
			case "-2r": blattAngabe = "Vorsatzblatt_r"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_Vorsatz_1r.jpg"; buchAuswahl = aktBuch + 1; break;
			case "-2v": blattAngabe = "Vorsatzblatt_v"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_Vorsatz_1v.jpg"; buchAuswahl = aktBuch + 1; break;
			case "-1r": blattAngabe = "Vorsatzblatt_r"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_Vorsatz_2r.jpg"; buchAuswahl = aktBuch + 1; break;
			case "-1v": blattAngabe = "Vorsatzblatt_v"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_Vorsatz_2v.jpg"; buchAuswahl = aktBuch + 1; break;
			case "0r": blattAngabe = "Vorsatzblatt_r"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_Vorsatz_3r.jpg"; buchAuswahl = aktBuch + 1; break;
			case "0v": blattAngabe = "Vorsatzblatt_v"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_Vorsatz_3v.jpg"; buchAuswahl = aktBuch + 1; break;
			
			case "37r": blattAngabe = "Einlageblatt_r"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_037r.jpg"; buchAuswahl = aktBuch + 1; break;
			case "37v": blattAngabe = "Einlageblatt_v"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_037v.jpg"; buchAuswahl = aktBuch + 1; break;
			case "38r": blattAngabe = "Einband hinten innen"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_Einband_hinten_innen.jpg"; buchAuswahl = aktBuch + 1; break;
			case "38v": blattAngabe = "Einband hinten aussen"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_Einband_hinten_aussen.jpg"; buchAuswahl = aktBuch + 1; break;
			case "39r": blattAngabe = "Einband hinten aussen"; lagenAngabe = ""; bildURL = zoom + "/Basel_KII11_Ruecken.jpg"; buchAuswahl = aktBuch + 1; break;
...
function bildAnzeigeDS() {
	...
	var tempv = "Basel_KII11_" + zusatzv + curSlide + addChar + 'v';
	var tempr = "Basel_KII11_" + zusatzr + nexSlide + nexChar + 'r';
	var bildURLv = "50/" + tempv + ".jpg";
	var bildURLr = "50/" + tempr + ".jpg";
	switch (curSlide) {

		case "-3":
			bildURLv = "50/Basel_KII11_Einband_vorne_innen.jpg";
			bildURLr = "50/Basel_KII11_Vorsatz_1r.jpg"; break;
		case "-2":
			bildURLv = "50/Basel_KII11_Vorsatz_1v.jpg";
			bildURLr = "50/Basel_KII11_Vorsatz_2r.jpg"; break;
		case "-1":
			bildURLv = "50/Basel_KII11_Vorsatz_2v.jpg";
			bildURLr = "50/Basel_KII11_Vorsatz_3r.jpg"; break;
		case "0":
			bildURLv = "50/Basel_KII11_Vorsatz_3v.jpg";
			bildURLr = "50/Basel_KII11_001r.jpg"; break;
		case "36":
			bildURLv = "50/Basel_KII11_036v.jpg";
			bildURLr = "50/Basel_KII11_037r.jpg"; break;
		case "37":
			bildURLv = "50/Basel_KII11_037v.jpg";
			bildURLr = "50/Basel_KII11_Einband_hinten_innen.jpg"; break;
		case "38":
			bildURLv = "50/Basel_KII11_Einband_hinten_aussen.jpg";
			bildURLr = "50/Basel_KII11_Ruecken.jpg"; break;
		default: break;
	...
	switch (curSlide) {
		...
		case "-3": seitenAngabe = "Einband vorne innen / Vorsatzblatt_r"; lagenAngabe = lagenNr + lagenName; buchAuswahl = aktBuch + 1; break;
		case "-2": seitenAngabe = "Vorsatzblatt_v / Vorsatzblatt_r"; lagenAngabe = lagenNr + lagenName; buchAuswahl = aktBuch + 1; break;
		case "-1": seitenAngabe = "Vorsatzblatt_v / Vorsatzblatt_r"; lagenAngabe = lagenNr + lagenName; buchAuswahl = aktBuch + 1; break;
		case "0": seitenAngabe = "Vorsatzblatt_v / Bl. 1r"; lagenAngabe = lagenNr + lagenName; buchAuswahl = aktBuch + 1; break;
		
		case "36": seitenAngabe = "36v/Einlageblatt_r"; lagenAngabe = lagenNr + lagenName; buchAuswahl = aktBuch + 1; break;
		case "37": seitenAngabe = "Einlageblatt_v/Einband hinten innen"; lagenAngabe = lagenNr + lagenName; buchAuswahl = aktBuch + 1; break;
		case "38": seitenAngabe = "Einband hinten aussen/Rücken"; lagenAngabe = lagenNr + lagenName; buchAuswahl = aktBuch + 1; break;
